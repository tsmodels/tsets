...
filter_aaa <- function(model_, y_, pars_, s0_, x_, good_) {
    .Call(`_tsets_filter_aaa`, model_, y_, pars_, s0_, x_, good_)
}

filter_mmm <- function(model_, y_, pars_, s0_, x_, good_) {
    .Call(`_tsets_filter_mmm`, model_, y_, pars_, s0_, x_, good_)
}

filter_mam <- function(model_, y_, pars_, s0_, x_, good_) {
    .Call(`_tsets_filter_mam`, model_, y_, pars_, s0_, x_, good_)
}

filter_powermam <- function(model_, y_, pars_, s0_, x_, good_) {
    .Call(`_tsets_filter_powermam`, model_, y_, pars_, s0_, x_, good_)
}
